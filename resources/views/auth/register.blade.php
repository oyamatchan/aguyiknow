...
<div class="container">
    ...
    <center><font size="2"><b>Fields marked with </b></font><font size="4" color="red"><b>*</b></font><font size="2"><b> are fillable informations.</b></font></center><br>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="contactNumber" type="text" class="form-control{{ $errors->has('contact') ? ' is-invalid' : '' }}" name="contactNumber" value="{{ old('contactNumber') }}" required>
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('Password') }}<font size="3" color="red"><b>*</b></font></label>

                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" placeholder="minimum of 6 characters long" required>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Confirm Password') }}<font size="3" color="red"><b>*</b></font></label>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4" align="center">
                                ...
                                <a class="text" href="{{ route('login') }}"><font size="2">Cancel registration</font></a>
                            </div>
                        </div>
